...
public class DAOTest {
	...
	@Test
	public void save() {
		User user = new User("user1@gmail.com", 1234, DateUtils.getLocalDate("1983-03-16", DateUtils.FORMAT_YYYY_MM_DD),
				DateUtils.getLocalDateTime("2022-03-05 18:36:36", DateUtils.FORMAT_YYYY_MM_DD_HH_MM_SS_24H), true,
				new Document("DNI", 10));

		boolean actual = userImplementation.save(user);
	...
	public void delete() {
		...
		boolean actual = userImplementation.delete(user);
		boolean expected = true;
		assertEquals(expected, actual);
	}
	...
	@Test
	public void find() {
		User userActual = new User("user1@gmail.com", 1234,
	...
	public void findAll() {
		...
		int actual = userImplementation.findAll().size();
		int expected = 3;
